...
public class CadastroPanel extends JPanel{
	...
	private void addComponent() {
		...
		add(getSaveButton(), getSaveButtonConstraints());
	}
	...
	public GridBagConstraints getSaveButtonConstraints() {
		if(saveButtonConstraints == null) {
			saveButtonConstraints = new GridBagConstraints();
			saveButtonConstraints.gridx = 2;
			saveButtonConstraints.gridy = 10;
			saveButtonConstraints.anchor = GridBagConstraints.EAST;
			saveButtonConstraints.insets = new Insets(25, 60, 5, 5);
		}
		return saveButtonConstraints;
	}
